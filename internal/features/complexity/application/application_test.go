...
func TestComputeForTypeAMC(t *testing.T) {
	...
	tf := &typefacts.TypeFacts{Methods: []typefacts.MethodFacts{
		{Name: "A", Branches: typefacts.BranchStats{Ifs: 2}},
		{Name: "B", Branches: typefacts.BranchStats{}},
		{Name: "C", Branches: typefacts.BranchStats{Fors: 1, Cases: 1}},
	}}
...
func TestComputeForTypeContract(t *testing.T) {
	...
	tf := &typefacts.TypeFacts{Methods: []typefacts.MethodFacts{
		{Name: "Do", Branches: typefacts.BranchStats{Ifs: 1, LogicalOps: 1}},
		{Name: "Noop"},
	}}
